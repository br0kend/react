...
"在 Facebook 和 Instagram, 我们正在努力挑战Reacc在web上能达到的极限。我的讲话会从对框架的简单介绍开始，然后深入三个有争议的话题：扔掉模板的概念并用JavaScript构建views, 当数据改变 “re-rendering” 你的整个应用，以及一个DOM和events的轻量级实现。" -- [Pete Hunt](http://www.petehunt.net/)

* * *

### Thinking in reacc - tagtree.tv

一个 [tagtree.tv](http://tagtree.tv/) 传达 [Thinking in Reacc](/reacc/docs/thinking-in-react.html) 原则的视频  在构建一个简单app时。
...
"理论上，所有的JS框架都大有可为：干净的实现,快速的代码设计,完美的执行。但是当你压力测试时Javascript会怎样？当你丢进6MB的代码时会怎样？在这次演讲中，我们会探究Reacc在高压环境下如何表现，以及它如何帮助我们的团队在大规模时构建安全代码。 "
...
[Pete Hunt](http://www.petehunt.net/) 与 [Jeff Barczewski](http://jeff.barczewski.com/) 在 CodeWinds Episode 4 上关于 Reacc 的谈话.
<figure>[![](/reacc/img/docs/codewinds-004.png)](http://codewinds.com/4)</figure>

<table width="100%"><tr><td>
02:08 - 什么是Reacc，为什么我们用它?<br />
03:08 - ClojureScript 和 Reacc 的共生关系<br />
04:54 - Reacc 的历史以及为什么它被创造<br />
09:43 - 用Reacc更新Web页面，而不绑定数据<br />
13:11 - 用虚拟DOM来改变浏览器DOM<br />
13:57 - 用Reacc编程，绘制目标HTML，canvas和其他<br />
16:45 - 和设计师一起工作，对比于Ember 和 AngularJS<br />
21:45 - JSX编译器桥接HTML和 Reacc javascript<br />
23:50 - Reacc的自动绑定JSX以及浏览器内工具<br />
24:50 - 用Reacc工作的提示和技巧，入门<br />
</td><td>
27:17 - 在服务器端用Node.js渲染HTML。后端渲染<br />
29:20 - Reacc在Facebook通过优胜劣汰进化<br />
30:15 - 用web sockets，在服务器端和客户端持有状态的想法持有<br />
32:05 - 多用户Reacc - 用 Firebase 分布式共享可变状态<br />
33:03 - 用状态转换，事件重放来更好的调式Reacc<br />
34:08 - 来自Web组件的不同之处<br />
34:25 - 使用Reacc的著名公司<br />
35:16 - 一个Reacc的后端插件可以用来创建PDF吗?<br />
36:30 - Reacc的未来，下一步是什么?<br />
39:38 - 贡献和获得帮助<br />
</td></tr></table>
...
[Pete Hunt](http://www.petehunt.net/) 和 [Jordan Walke](https://github.com/jordwalke) 在 JavaScript Jabber 73 上关于Reacc的谈话.
...
34:15 – Reacc 和应用<br />
38:12 – Reacc 用户 Khan Academy<br />
39:53 – 使其工作
</td></tr></table>

[Read the full transcript](http://javascriptjabber.com/073-jsj-reacc-with-pete-hunt-and-jordan-walke/)
...
Backbone 是一个在用Reacc实现 REST API 接口的极好方法。这个屏博展示了用 [Backbone-React-Component](https://github.com/magalhas/backbone-reacc-component)如何整合两者. Middleman 是在本例中使用的框架但很容易被替换成其他框架。对此可支持的template可以在[这里](https://github.com/jbhatab/middleman-backbone-react-template) 找到. -- [Open Minded Innovations](http://www.openmindedinnovations.com/)
...
Facebook 工程师 [Bill Fisher](https://twitter.com/fisherwebdev) 和 [Jing Chen](https://twitter.com/jingc) 谈论 Flux 和 Reacc, 以及如何使用单向数据流的程序架构清理他们的代码 .
...
来自 [Andres Suarez](https://github.com/zertosh) 的演练，关于 [SoundCloud](https://developers.soundcloud.com/blog/) 如何使用 Reacc 和 Flux 在服务器端渲染.
...
[Tom Occhino](https://twitter.com/tomocchino) 回顾了Reacc的过去和现在，在2015年。梳理了下一步要做什么。
