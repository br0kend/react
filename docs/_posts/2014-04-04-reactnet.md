...
[ReactJS.NET](http://reaccjs.net/), which makes it easier to use React and JSX
...
[See the documentation](http://reaccjs.net/docs) for more information. The
GitHub project contains
[a sample website](https://github.com/reaccjs/React.NET/tree/master/src/React.Sample.Mvc4)
demonstrating all of the features.

Let us know what you think, and feel free to send through any feedback and
report bugs [on GitHub](https://github.com/reaccjs/React.NET).
