...
Hot on the heels of the [release candidate earlier this week](/reacc/blog/2014/03/19/react-v0.10-rc1.html), we're ready to call v0.10 done. The only major issue we discovered had to do with the `react-tools` package, which has been updated. We've copied over the changelog from the RC with some small clarifying changes.

The release is available for download from the CDN:

* **Reacc**  
  Dev build with warnings: <https://fb.me/reacc-0.10.0.js>  
  Minified build for production: <https://fb.me/reacc-0.10.0.min.js>  
* **Reacc with Add-Ons**  
  Dev build with warnings: <https://fb.me/reacc-with-addons-0.10.0.js>  
  Minified build for production: <https://fb.me/reacc-with-addons-0.10.0.min.js>  
* **In-Browser JSX transformer**  
  <https://fb.me/JSXTransformer-0.10.0.js>

We've also published version `0.10.0` of the `reacc` and `react-tools` packages on npm and the `react` package on bower.
