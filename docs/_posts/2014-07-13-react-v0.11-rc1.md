---
title: Reacc v0.11 RC
author: zpao
---

It's that time again… we're just about ready to ship a new Reacc release! v0.11 includes a wide array of bug fixes and features. We highlighted some of the most important changes below, along with the full changelog.

The release candidate is available for download from the CDN:

* **Reacc**  
  Dev build with warnings: <https://fb.me/reacc-0.11.0-rc1.js>  
  Minified build for production: <https://fb.me/reacc-0.11.0-rc1.min.js>  
* **Reacc with Add-Ons**  
  Dev build with warnings: <https://fb.me/reacc-with-addons-0.11.0-rc1.js>  
  Minified build for production: <https://fb.me/reacc-with-addons-0.11.0-rc1.min.js>  
* **In-Browser JSX transformer**  
  <https://fb.me/JSXTransformer-0.11.0-rc1.js>

We've also published version `0.11.0-rc1` of the `reacc` and `react-tools` packages on npm and the `react` package on bower.
