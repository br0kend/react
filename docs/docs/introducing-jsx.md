...
JSX produces React "elements". We will explore rendering them to the DOM in the [next section](/reacc/docs/rendering-elements.html). Below, you can find the basics of JSX necessary to get you started.
