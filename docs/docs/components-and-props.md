...
Classes have some additional features that we will discuss in the [next sections](/reacc/docs/state-and-lifecycle.html). Until then, we will use functional components for their conciseness.
...
Of course, application UIs are dynamic and change over time. In the [next section](/reacc/docs/state-and-lifecycle.html), we will introduce a new concept of "state". State allows React components to change their output over time in response to user actions, network responses, and anything else, without violating this rule.
